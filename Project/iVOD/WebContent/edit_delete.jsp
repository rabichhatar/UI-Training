...
<head>
	...
	<style>
	   	/*CSS for search forms*/
	   	 #serach_option_main{float: left;height: 100%;}
	   	 #search_lbl_div{float:left;height: 100%;padding-left: 5px;padding: 3px 10px 0 0;margin-left: 260px;}
	   	 #search_sbmt_div{clear: both; margin: 50px 0 50px 480px;float: left;}
	    ...
	    .remove_btn{display: none;}
	   	#message_div{ background-color: #90EE90;
	    ...
	    #select_columns_popup, #show_detail_popup,#delete_conf_popup{text-align:center;display: none;background: #F0F0F0 !important;}
		...
		tr.ui-widget-content.highlight{background:none repeat scroll 0 0 orange !important;}
		...
		.hover-element{ padding : 7px 0; position:absolute; right: 0px;}
		.hover-element .delete { height: 15px; width: 15px; vertical-align: middle; display: inline-block; padding: 0 5px;
			background: url('images/delete.png') no-repeat center center;
		 }
		.hover-element .edit { height: 15px; width: 18px; vertical-align: middle; display: inline-block; padding: 0 1px;
			background: url('images/Edit-pencil.png') no-repeat scroll 0px 0px;
			background-size: 15px;
		 }
		 #show_detail_popup div.textbox1{ margin-left: 0px;}
		 #show_detail_popup div.mkt_desc {width: 191px}
	</style>
</head>
<body>
<div id="wrapper">
...
<div id="select_columns_popup" style="box-shadow:blue;" title="Add/Remove Columns">
	...
	<div style="clear: both;margin-bottom: 30px;">
		<input type="button" value="OK" class="popupBtn" onclick="updateTable()"/> <input style="margin-left: 60px;" class="popupBtn" type="button"
				onclick="resetToPrev()" value="Cancel">
		</div>
</div>

<div id="show_detail_popup" title="Edit/Delete Series > Market Details">
	
</div>
<div id="delete_conf_popup" title="Confirm Delete">
	
</div>
<script>
var responceType = "<%=(request.getParameter("type")!=null?(String)request.getParameter("type"):"ivodSeries")%>";
var applicationContext = "<%=request.getContextPath()%>";
</script>
</body>